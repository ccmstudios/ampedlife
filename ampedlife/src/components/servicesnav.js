...
const ServicesNav = () => {
  ...
  const gotobirthplanning = () =>
    window.scrollTo({
      top: birthplanning.current,
      behavior: "smooth",
    });
  const gotobirthdoulasupport = () =>
    window.scrollTo({
      top: birthdoula.current,
      behavior: "smooth",
    });
  const gotobirthafterloss = () =>
    window.scrollTo({
      top: birthafterloss.current,
      behavior: "smooth",
    });
  const gotopostpartum = () =>
    window.scrollTo({
